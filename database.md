...
CREATE UNIQUE INDEX PLANT_ITEMS_ID_PK ON PLANT_ITEMS (ID);
...
CREATE OR REPLACE package plant_item_pkg as
...
CREATE UNIQUE INDEX ISOLATION_POINTS_ID_PK ON ISOLATION_POINTS (ID);
